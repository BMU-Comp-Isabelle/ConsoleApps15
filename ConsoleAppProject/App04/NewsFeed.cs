...
namespace ConsoleAppProject.App04
{
    ...
    {
        public const string AUTHOR = "Steve";
        ...
        {
            posts = new List<Post>();
            MessagePost post = new MessagePost(AUTHOR, "That cherry tomato made me jump");
            AddMessagePost(post);

            PhotoPost photoPost = new PhotoPost(AUTHOR, "mycat.png", "I love cats");
